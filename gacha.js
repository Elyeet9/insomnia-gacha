...
var phos = function() {
    ...
    if(result >= 21 && result <= 30) {
        ...
        embed.setFooter('Bracers of Archery');
        ...
        embed.setFooter('Ring of Water Walking');
        ...
        embed.setFooter('Eversmoking Bottle');
        ...
        embed.setFooter('Gloves of Missile Snaring');
...
var pull = function() {
    ...
    const embed = new MessageEmbed()
        ...
        .setTitle('Resultado')
        .setURL('https://youtu.be/iik25wqIuFo')
        .setDescription('» Roll: [' + result + '] «')
        .setTimestamp();

    if(result == 1 ) {
        embed.setFooter('x10 Gromps');
        ...
        embed.setFooter('x10 Gold Piece');
